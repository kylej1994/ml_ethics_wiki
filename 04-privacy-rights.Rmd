...
Apathy is not an excuse. Many practitioners defend the ethically questionable nature of the software they create by positing that they are "just an engineer" or "just a researcher". This is simply untrue. The notion that someone could cordone off their impact to society and the world to one minor slice of their identity is utterly fanciful. Rightly or wrongly, all are judged for their contributions to society. Those who are "just researchers" must take extra steps to ensure that their research is not used in a manner that is unethical.

Don't create surveillance software. If software has shades of 1984, just don't do it. 

## Resources

**An article to read: ** [___]
