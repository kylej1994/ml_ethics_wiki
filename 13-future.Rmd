...
AI regulation has a long way to go. It is in a period of infancy, and relative experimentation. The European Union, have passed laws are still figuring out how to optimize the enforcement mechanisms available to them. In the European Union, it is likely that enforcement will ramp up.The United States is relatively early on this process; there has been very little federal activity, and much experimentation on the state level. The federal government has made definitive steps to outline the rights to privacy of individuals, and structuring how those rights can fit into additional regulation. 
