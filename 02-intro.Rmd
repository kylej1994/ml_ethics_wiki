...
```{r newyorker, echo = FALSE, fig.cap = "An article from the New Yorker",width=500}
knitr::include_graphics("imgs/newyorker_unethical.jpg")
```
...
```{r kdn, echo = FALSE, fig.cap = "2017 KDNuggets Poll",width=500}
knitr::include_graphics("imgs/kdn_poll.jpg")
```
...
```{r oreillyml, echo = FALSE, fig.cap = "From Geron's 'Hands on Machine Learning",width=500}
knitr::include_graphics("imgs/oreilly.jpg")
```
